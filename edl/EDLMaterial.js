...
export class EDLMaterial extends THREE.RawShaderMaterial{
	...
	constructor(parameters = {}){
		...
		this.setValues({
			uniforms: uniforms,
			vertexShader: this.getDefines() + ``,
			fragmentShader: this.getDefines() + ``,
			lights: false
		});
	...
	updateShaderSource() {
		...
		let vs = this.getDefines() + ``;
		let fs = this.getDefines() + ``;
